...
const UserLayout = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            // Mock data untuk user (berbeda dengan admin)
            const mockNotifications = generateUserNotifications();
        ...
        return [
            {
                ...
                message:
                    "Laporan harian Anda untuk hari ini telah berhasil dikirim",
                time: "10 menit lalu",
                read: false,
                priority: "high",
            },
            {
                ...
                message: "Jangan lupa kirim laporan harian sebelum jam 18:00",
                time: "2 jam lalu",
                read: false,
                priority: "medium",
            },
            {
                ...
                title: "Target Harian",
                message:
                    "Anda telah mencapai 85% dari target penjualan hari ini",
                time: "4 jam lalu",
                read: true,
                priority: "medium",
            },
            {
                ...
                message: "Versi 2.1.0 sudah tersedia untuk perangkat Anda",
                time: "1 hari lalu",
                read: true,
                priority: "low",
            },
    ...
    const navigationItems = [
        ...
        //     icon: faChartBar,
        //     label: "Report",
        //     active: location.pathname.startsWith("/user/reports"),
        // },
        // Profil dipindah ke user dropdown
    ];
            ...
            <header style={styles.header}>
                ...
                <div style={styles.headerCenter}>
                    <div style={styles.searchContainer}>
                        ...
                        <input
                            type="text"
                            placeholder="Cari laporan atau outlet..."
                            value={searchQuery}
...
// Styles yang sama dengan AdminLayout, dengan beberapa penyesuaian kecil
const styles = {
    container: {
        minHeight: "100vh",
