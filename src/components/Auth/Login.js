...
const Login = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            description:
                "Atur akses pengguna dengan sistem role-based yang aman",
            color: "#8b5cf6",
        },
        {
                    ...
                    <div style={styles.appInfo}>
                        <div style={styles.appHeader}>
                            ...
                            <p style={styles.appTagline}>
                                Platform Terintegrasi Monitoring dan Analisis
                                Performa Outlet
                            </p>
                        </div>
                        ...
                        <div style={styles.securityInfo}>
                            ...
                            <p style={styles.securityText}>
                                Sistem dilengkapi dengan enkripsi end-to-end,
                                autentikasi dua faktor, dan audit log untuk
                    ...
                    <div style={styles.loginCard}>
                        <div style={styles.loginHeader}>
                            ...
                            <p style={styles.loginSubtitle}>
                                Gunakan username dan password untuk mengakses
                                dashboard
                            </p>
                        </div>
