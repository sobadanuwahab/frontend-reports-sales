        ...
        for (let i = 1; i < Math.min(6, lines.length); i++) {
            if (lines[i].trim()) {
                ...
                try {
                    ...
                    const row = {
                        kode_outlet:
                            cleanedValues[headerMapping["kode_outlet"]] || "",
                        nama_outlet:
                            cleanedValues[headerMapping["nama_outlet"]] || "",
                        lob:
                ...
                if (error.response.status === 422) {
                    ...
                    if (errorData.errors) {
                        if (typeof errorData.errors === "object") {
                            ...
                            errorMessages = [
                                errorData.message || "Validasi gagal",
                            ];
                        }
                    } else {
                        errorMessages = [
                            errorData.message || "Format file tidak valid",
                        ];
                    }

                    setImportErrors(errorMessages);
                    setStatusMessage(
                        "Validasi file gagal. Periksa format file.",
                    );
                } else if (error.response.status === 401) {
                    setImportErrors([
                        "Sesi telah berakhir. Silakan login kembali.",
                ...
                <div style={styles.header}>
                    ...
                    <div style={styles.headerContent}>
                        ...
                        <p style={styles.subtitle}>
                            ...
                            ke sistem atau import dari file
                        </p>
                        <p style={styles.subtitleSmall}>
                            <strong>Catatan:</strong> Kode outlet dapat
                            mengandung huruf, angka, spasi, dash (-), dan
                            underscore (_)
                        </p>
                    </div>
                    ...
                    <div style={styles.formGrid}>
                        ...
                        <div style={styles.formGroup}>
                            ...
                            <p style={styles.helperText}>
                                Kode unik untuk identifikasi outlet. Contoh:
                                OUT-001, OUT_001, OUT 001, CAFE-01
                            </p>
                        </div>
                        ...
                        <div style={styles.modalBody}>
                            ...
                            <div style={styles.templateSection}>
                                ...
                                <p style={styles.sectionText}>
                                    Unduh template CSV untuk mengisi data outlet
                            ...
                            <div style={styles.uploadSection}>
                                ...
                                <p style={styles.sectionText}>
                                    Upload file CSV (.csv) dengan data outlet.
                                ...
                                >
                                    <li>
                                        Delimiter: titik koma (;) atau koma (,)
                                    </li>
                                    <li>
                                        Kolom wajib: kode_outlet, nama_outlet
                                    </li>
                                    <li>Kolom opsional: lob</li>
                                    <li>
                                        Contoh:{" "}
                                        <code>kode_outlet;nama_outlet;lob</code>
                                    </li>
                                </ul>
                                ...
                                <div style={styles.fileUploadArea}>
                                    ...
                                    >
                                        ...
                                        <p style={styles.uploadSubtext}>
                                            Format: CSV dengan delimiter ; atau
                                            , (Maks. 5MB)
                                        </p>
                                        {!importFile && (
                                            <div
                                ...
                                {importFile &&
                                    ...
                                    importErrors.length === 0 && (
                                        ...
                                        >
                                            ...
                                            />
                                            Preview tidak tersedia atau file
                                            berformat Excel. Klik "Import Data"
                                            untuk melanjutkan.
                                        </div>
                                    )}
