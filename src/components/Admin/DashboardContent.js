...
const DashboardContent = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      if (dayData.length > 0) {
        ...
        const avgAchievement =
          dayData.length > 0
            ? dayData.reduce(
                (sum, item) => sum + (item.achievement_percentage || 0),
                0,
              ) / dayData.length
            : 0;
        const outletCount = [
  ...
  const fetchOutlets = async () => {
    try {
      ...
      allOutlets.sort((a, b) => a.nama_outlet.localeCompare(b.nama_outlet));

      setOutlets(allOutlets);
      const uniqueLobs = [...new Set(allOutlets.map((o) => o.lob))].sort();
    ...
    try {
      ...
      if (response.data.success && response.data.data) {
        reportsData = response.data.data.map((report) => ({
          ...
          target_percentage: parseFloat(report.target_percentage) || 0,
        ...
        reportsData = response.data.map((report) => ({
          ...
          outlet_id: report.outlet_id,
          outlet_name:
            report.outlet?.nama_outlet || report.outlet_name || "Unknown",
          lob: report.lob || report.outlet?.lob || "Cafe",
          omzet_fnb: parseFloat(report.omzet_fnb) || 0,
          omzet_cinema: parseFloat(report.omzet_cinema) || 0,
          total_bills: parseInt(report.total_bills) || 0,
      ...
      const transformedData = reportsData.map((report) => {
        ...
        const perHeadActual =
          report.total_audience > 0
            ? Math.round((report.omzet_fnb || 0) / report.total_audience)
            : 0;
        ...
        const totalSales = (report.omzet_fnb || 0) + (report.omzet_cinema || 0);
  ...
  const renderTargetVsPerHeadChart = () => {
    return <TargetHeadVsPerHeadAnalysis performanceData={performanceData} />;
  };
  ...
  const renderDailyChart = () => {
    ...
    const selectedOption = chartOptions[dataKey] || chartOptions.total_sales;
        ...
        <ResponsiveContainer width="100%" height="100%" minHeight="400px">
          ...
          >
            ...
            <YAxis
              ...
              label={{
                value:
                  dataKey === "ds" || dataKey === "achievement"
                    ? "Persentase (%)"
                    : "Nilai",
                angle: -90,
                position: "insideLeft",
    ...
    return (
      <ResponsiveContainer width="100%" height="100%" minHeight="400px">
        ...
        >
          ...
          <Tooltip content={<CustomTooltip />} />
          <Legend verticalAlign="top" height={36} />
          <Bar dataKey="per_head_fnb" name="Per Head F&B" radius={[4, 4, 0, 0]}>
      ...
      <div style={styles.contentWrapper}>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.filterGrid}>
            ...
            <div style={styles.filterActions}>
              <button onClick={handleApplyFilter} style={styles.applyButton}>
                <FontAwesomeIcon
                  icon={faFilter}
              ...
              <button onClick={handleResetFilter} style={styles.resetButton}>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            ...
            <p style={styles.sectionSubtitle}>
              Overview performa outlet dengan fokus pada Food & Beverage
            </p>
          </div>
          ...
          <div style={styles.summaryGrid}>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryContent}>
                <h3 style={styles.summaryTitle}>Total Omzet F&B</h3>
                <p style={styles.summaryValue}>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryContent}>
                <h3 style={styles.summaryTitle}>Total Omzet Cinema</h3>
                <p style={styles.summaryValue}>
                  {formatNumber(summaryStats.totalCinema || 0)}
                </p>
              </div>
            </div>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryContent}>
                <h3 style={styles.summaryTitle}>Rata-rata DS</h3>
                <p style={styles.summaryValue}>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryContent}>
                <h3 style={styles.summaryTitle}>Rata-rata Achievement</h3>
                <p style={styles.summaryValue}>
                  {formatPercentage(summaryStats.avgAchievement || 0)}
                </p>
              </div>
            </div>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryContent}>
                <h3 style={styles.summaryTitle}>Total Audience</h3>
                <p style={styles.summaryValue}>
                  {formatNumber(summaryStats.totalAudience || 0)}
                </p>
              </div>
            </div>
          </div>
        ...
        <div style={styles.section}>
          <div style={styles.chartSectionHeader}>
            <div style={styles.chartTitleSection}>
              ...
              <p style={styles.sectionSubtitle}>
                Analisis visual data performa harian 1 bulan penuh
              </p>
            </div>

            <div style={styles.chartControlsContainer}>
              <div style={styles.chartTypeContainer}>
                <label style={styles.controlLabel}>Tipe Chart:</label>
                <div style={styles.chartTypeButtons}>
                  <button
                    onClick={() => handleChartTypeChange("targetVsPerHead")}
                    style={{
                      ...styles.chartTypeBtn,
                  ...
                  >
                    <FontAwesomeIcon icon={faBullseye} />
                    <span style={styles.chartTypeLabel}>Target vs PerHead</span>
                  </button>
                  <button
                    onClick={() => handleChartTypeChange("bar")}
                    style={{
                      ...styles.chartTypeBtn,
                      ...(chartType === "bar" && styles.activeChartTypeBtn),
                    }}
                    title="Bar Chart"
                  >
                    <FontAwesomeIcon icon={faChartBar} />
                    <span style={styles.chartTypeLabel}>Bar</span>
                  </button>
                  <button
                    onClick={() => handleChartTypeChange("line")}
                    style={{
                      ...styles.chartTypeBtn,
                      ...(chartType === "line" && styles.activeChartTypeBtn),
                    }}
                    title="Line Chart"
                  >
                    <FontAwesomeIcon icon={faChartLine} />
                    <span style={styles.chartTypeLabel}>Line</span>
                  </button>
                  {/* <button
                                        onClick={() =>
              ...
              <div style={styles.chartDataContainer}>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    handleChartDataChange(type, metricMap[type]);
                  }}
                ...
                >
                  ...
                  <option value="per_head_fnb">Per Head F&B</option>
                  <option value="ds">DS Percentage</option>
                  <option value="achievement">Achievement Percentage</option>
                  <option value="audience">Audience</option>
                  <option value="target_head">Target Head</option>
                </select>
              </div>
            ...
            <div style={styles.chartContainer}>
              <div style={styles.chartInfo}>
                <div style={styles.chartInfoItem}>
                  <span style={styles.chartInfoLabel}>Periode:</span>
                  <span style={styles.chartInfoValue}>
                    {months.find((m) => m.value === filter.month)?.label}{" "}
                    {filter.year}
                  </span>
                </div>
                <div style={styles.chartInfoItem}>
                  <span style={styles.chartInfoLabel}>Outlet:</span>
                  <span style={styles.chartInfoValue}>
                    {filter.outlet === "all"
                      ? "Semua Outlet"
                      : outlets.find((o) => o.id.toString() === filter.outlet)
                          ?.nama_outlet || "Outlet Dipilih"}
                  </span>
                </div>
                <div style={styles.chartInfoItem}>
                  <span style={styles.chartInfoLabel}>Jumlah Data:</span>
                  <span style={styles.chartInfoValue}>
                    {chartType === "perHead"
                      ? perHeadData.length
                      : dailyData.length}
                ...
                <div style={styles.chartInfoItem}>
                  <span style={styles.chartInfoLabel}>Tipe Chart:</span>
                  <span style={styles.chartInfoValue}>
                    {chartType === "perHead"
                      ? "Per Head"
                      : chartType === "bar"
                ...
                <div style={styles.chartInfoItem}>
                  <span style={styles.chartInfoLabel}>Data:</span>
                  <span style={styles.chartInfoValue}>
          ...
          {performanceData.length > 0 ? (
            <div style={styles.performanceContainer}>
              <div style={styles.tableContainer}>
                <table style={styles.performanceTable}>
                  <thead>
                    <tr>
                      <th style={styles.tableHeader}>Outlet</th>
                      <th style={styles.tableHeader}>LOB</th>
                      <th style={styles.tableHeader}>Class</th>
                      <th style={styles.tableHeader}>Tanggal</th>
                      <th style={styles.tableHeader}>Target Head</th>
                      <th style={styles.tableHeader}>Per Head</th>
                      <th style={styles.tableHeader}>F&B Sales</th>
                      <th style={styles.tableHeader}>Cinema Sales</th>
                      <th style={styles.tableHeader}>Total Sales</th>
                      <th style={styles.tableHeader}>DS (%)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {performanceData.map((item) => {
                      const dsNum = parseFloat(item.ds_percentage) || 0;
                      const totalSales =
                        (item.omzet_fnb || 0) + (item.omzet_cinema || 0);
                      ...
                      const isPerHeadAboveTarget =
                        targetHead > 0 && perHeadActual >= targetHead;
                      const perHeadColor = isPerHeadAboveTarget
                        ? "#10b981"
                        : "#ef4444";

                      // Tentukan warna untuk DS berdasarkan threshold 33.5%
                      const DS_THRESHOLD = 33.5; // Rata-rata dari 33-34%
                      const isDSAboveThreshold = dsNum >= DS_THRESHOLD;
                        ...
                        >
                          ...
                          <td style={styles.tableCell}>
                            ...
                            >
                              ...
                              >
                                {" "}
                                {safeFormatNumber(perHeadActual)}
                              </strong>
                              <div
                                style={{
                                  fontSize: "0.75rem",
                          ...
                          <td style={styles.tableCell}>
                            ...
                            >
                              ...
                              >
                                {" "}
                                {safeFormatNumber(item.omzet_fnb)}
                              </strong>
                              <div
                                style={{
                                  fontSize: "0.75rem",
                          ...
                          <td style={styles.tableCell}>
                            ...
                            >
                              ...
                              >
                                {" "}
                                {safeFormatNumber(item.omzet_cinema)}
                              </strong>
                              <div
                                style={{
                                  fontSize: "0.75rem",
                          ...
                          <td style={styles.tableCell}>
                            <div style={styles.dsIndicator}>
                              <div
                                style={{
                                  ...styles.dsBar,
                                  width: `${Math.min(100, dsNum)}%`,
                              ...
                              >
                                {formatPercentage(item.ds_percentage)}
                              </span>
                              <div
                                style={{
                                  fontSize: "0.75rem",
              ...
              <div style={styles.legendContainer}>
                <div style={styles.legendTitle}>Keterangan Warna:</div>
                <div style={styles.legendGrid}>
                  <div style={styles.legendSection}>
                    <div style={styles.legendSubtitle}>Per Head:</div>
                    <div style={styles.legendItems}>
                      ...
                      <div style={styles.legendItem}>
                        ...
                        ></div>
                        <span style={styles.legendText}>
                          Per Head &lt; Target Head (Belum Tercapai)
                        </span>
                      </div>
                    </div>
                  </div>
                  <div style={styles.legendSection}>
                    <div style={styles.legendSubtitle}>DS (Daily Sales):</div>
                    <div style={styles.legendItems}>
                      <div style={styles.legendItem}>
                        <div
                          style={{
            ...
            <div style={styles.emptyState}>
              ...
              <p style={styles.emptyText}>
                Tidak ada data performa yang ditemukan untuk periode yang
                dipilih
              </p>
              <p style={styles.emptySubtext}>
                Coba gunakan filter yang berbeda atau periksa data laporan Anda
              </p>
            </div>
          )}
        </div>
